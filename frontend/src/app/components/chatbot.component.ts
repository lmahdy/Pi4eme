...
@Component({
  ...
  template: `
    ...
    <button *ngIf="!isOpen"
            ...
            (click)="toggleChat()"
            type="button"
            aria-label="Ouvrir l'assistant Tenexa"
  ...
  styles: [`
    ...
    .chatbot-widget {
      ...
      transition: transform, opacity, color, background-color, border-color, box-shadow 0.3s cubic-bezier(0.4, 0, 0.2, 1);
    }
    ...
    .close-btn {
      ...
      transition: transform, opacity, color, background-color, border-color, box-shadow 0.3s ease;
      flex-shrink: 0;
    }
