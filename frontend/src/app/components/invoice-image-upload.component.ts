...
@Component({
  ...
  `,
  styles: [`
    .upload-area { text-align: center; padding: 32px; border: 2px dashed var(--border-color, #ddd); border-radius: 8px; background: var(--bg-secondary, #f9f9f9); transition: transform, opacity, color, background-color, border-color, box-shadow 0.2s; }
    .upload-area:hover, .upload-area.drag-over { border-color: #5483B3; background: var(--bg-hover, #f0f7ff); }
    .btn-upload { padding: 10px 20px; font-size: 14px; background: #5483B3; color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; transition: transform, opacity, color, background-color, border-color, box-shadow 0.2s; }
    ...
    .btn-add-row { background: none; border: 1px dashed var(--border-color, #ccc); color: var(--text-muted, #666); padding: 6px 14px; border-radius: 4px; cursor: pointer; font-size: 12px; margin-bottom: 14px; transition: transform, opacity, color, background-color, border-color, box-shadow 0.2s; }
    ...
    .btn-primary, .btn-secondary { padding: 8px 18px; border: none; border-radius: 6px; cursor: pointer; font-weight: 600; font-size: 13px; transition: transform, opacity, color, background-color, border-color, box-shadow 0.2s; }
